const Navbar = () => {
  return (
	<div className="w-[80%] mx-auto p-4 h-screen mt-40 lg:mt-28">
		<div className="mt-10 lg:mt-28 w-full grid grid-cols-1 lg:grid-cols-2 justify-center items-center gap-3">
			<div className="w-full lg:w-fit mt-[-30px] flex flex-col justify-start items-stat space-y-10 gap-5">
				<h1 className="text-2xl md:text-4xl  tracking-widest">Search for a job ?</h1>
				<h3 className="text-xl md:text-3xl mt-3 tracking-widest">Find the best startup job that fit you</h3>
			...
			<img className="mt-20 lg:mt-0 w-full lg:w-fit bg-cover object-center" src="images/navbarbg.png" alt="" />
		</div>
	</div>
  )
}
