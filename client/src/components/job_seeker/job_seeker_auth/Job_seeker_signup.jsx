...
import { useRegisterJobSeekerMutation } from '../../../redux/job_seeker_redux/slices/job_seeker_slice'
const Job_seeker_signup = () => {
	...
	<div className="w-[80%] mx-auto mt-32 p-4">
		...
		onSubmit={onSubmit}>
			<Form className='w-full md:w-[45%] bg-white rounded-md shadow-md p-4 mx-auto flex flex-col justify-start items-start gap-2 space-y-5'>
				...
				<Field className=' w-full p-3 border-2 border-[#f5f5f5] rounded outline-[#007bff]' type='text' placeholder='Enter Full Name ' name='fullName'/>
				...
				<p className=' text-base tracking-widest'>Already have an Account? <Link className=' text-[#007bff]' to='/Job_seeker_signin'> Sign In</Link></p>
			</Form>
		</Formik>
	</div>
  )
...
export default Job_seeker_signup