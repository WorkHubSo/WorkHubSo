...
const Home = () => {
	...
	return (
		<>
			...
			<div className='w-full mt-14 p-5 lg:p-10 bg-[#007bff]'>
				...
				justify-start items-start gap-4'>
					...
					<div className='w-full'>
						<img className='w-full lg:w-64 lg:h-40 hover:shadow rounded-md transition-all ease-in-out duration-500 cursor-pointer bg-[#007bff] hover:bg-green-500' src="../../public/images/hormud_logo.png" alt="" />
					</div>


					<div className='w-full'>
						<img className='w-full lg:w-64 lg:h-40 hover:shadow rounded-md transition-all ease-in-out duration-500 cursor-pointer bg-[#007bff] hover:bg-yellow-500' src="../../public/images/somtel_logo.png" alt="" />
					</div>

					<div className='w-full'>
						<img className='w-full lg:w-64 lg:h-40 hover:shadow rounded-md transition-all ease-in-out duration-500 cursor-pointer bg-[#007bff] border-none hover:bg-slate-100' src="../../public/images/ibs_logo.png" alt="" />
					</div>

					<div className='w-full'>
						<img className='w-full lg:w-64 lg:h-40 hover:shadow rounded-md transition-all ease-in-out duration-500 cursor-pointer bg-[#007bff] hover:bg-slate-100' src="../../public/images/somnet_logo.png" alt="" />
					</div>

					<div className='w-full'>
						<img className='w-full lg:w-64 lg:h-40 hover:shadow rounded-md transition-all ease-in-out duration-500 cursor-pointer bg-[#007bff] hover:bg-slate-100' src="../../public/images/jtech_logo.png" alt="" />
					</div>
			...
			<div className='w-full mt-14 p-5 lg:p-10'>
				...
				<div className='mt-10 w-[90%] lg:w-[80%] mx-auto'>
					<p className=' text-lg lg:tracking-widest text-center leading-10'>Stay connected with us and never miss out on the latest updates, exclusive offers, and valuable insights. Subscribe to our newsletter and be the first to know about new job opportunities, industry trends, and career resources. Don`t wait, join our community today</p>
