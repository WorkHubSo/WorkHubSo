...
import { About, Candidate, Change_password, Company_dashboard, Contact, Dashboard, Edit_profile, Employer_signin, Employer_signup, Home, Job_detail, Job_seeker_manage_profile, Job_seeker_signin, Job_seeker_signup, Jobs, JopOffer, Manage_jobs, Resume_detail, Resumes, View_Job_detail } from './index'
import './App.css'
